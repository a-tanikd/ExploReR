...
public class ReorderingMutationTest {
  ...
  private final int mutationGeneratingCount = 15;
  ...
  public void testGeneratedVariantsSize() {
    ...
    final ReorderingMutation mutation = createReorderingMutation(generatedSourceCode);
    final List<Variant> variantList = mutation.exec(variantStore);
  ...
  private ReorderingMutation createReorderingMutation(final GeneratedSourceCode sourceCode) {
    final Random random = new MockRandom(0);
    return createReorderingMutation(sourceCode, random);
  }
