...
import jp.kusumotolab.kgenprog.ga.DUChainDistanceValidation;
...
import jp.kusumotolab.kgenprog.ga.ReorderingMutation;
...
public class CUILauncher {
  ...
  public void launch(final Configuration config) {
    ...
    final FaultLocalization faultLocalization = new DUChainDistanceLocalization();
